...
case "$OSTYPE" in
    linux*)
        ...
        case "$ID" in
            centos*)
                ...
                package=powershell-6.2.0-preview.3-1.rhel.7.x86_64.rpm
                ;;
            ubuntu)
                if ! hash curl 2>/dev/null; then
                    echo "curl not found, installing..."
                ...
                case "$VERSION_ID" in
                    14.04)
                    https://github.com/PowerShell/PowerShell/releases/download/v6.2.0-preview.3/powershell-preview_6.2.0-preview.3-1.ubuntu.14.04_amd64.deb
                        package=powershell-preview_6.2.0-preview.3-1.ubuntu.14.04_amd64.deb
                        ;;
                    16.04)
                        package=powershell-preview_6.2.0-preview.3-1.ubuntu.16.04_amd64.deb
                        ;;
                    *)
    ...
    darwin*)
        ...
        package=powershell-6.2.0-preview.3-osx-x64.pkg
        ;;
    *)
